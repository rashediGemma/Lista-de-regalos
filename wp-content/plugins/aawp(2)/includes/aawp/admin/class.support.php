...
if (!class_exists('AAWP_Support')) {
    ...
    class AAWP_Support {
        ...
        public function settings_callback( $input ) {
            ...
            if ( isset ( $input['reset_database'] ) && $input['reset_database'] === '1' ) {
                aawp_add_log( '*** INITIATED RESET OF DATABASE TABLES ***' );
                aawp_reset_database();
                unset( $input['reset_database'] );
            }
        ...
        public function settings_section_render() {
            ...
            //$disable_debug_logging = ( isset ( $this->options['support']['disable_debug_logging'] ) && $this->options['support']['disable_debug_logging'] == '1' ) ? 1 : 0;
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ( !empty ( $this->options['api']['error'] ) ) {
                            echo '<p style="margin-top: 15px;"><code>' . aawp_get_api_error_message_text($this->options['api']['error']) . '</code></p>';
                        }
                        ?>
                    </td>
                </tr>
            ...
            <table class="widefat">
                ...
                <?php do_action( 'aawp_support_cache_table_rows', $aawp_plugin_url ); ?>
            ...
            <p>
                <input type="checkbox" id="aawp_support_reset_database" name="aawp_support[reset_database]" value="1">
                <label for="aawp_support_reset_database"><?php _e('Reset database tables and remove all products and lists.', 'aawp'); ?> <strong style="color: red;"><?php _e('This action is not reversible!', 'aawp'); ?></strong></label>
            </p>
            ...
            <p>
                <strong><?php _e('Logs', 'aawp'); ?></strong><br />
                <textarea id="aawp-debug-log" readonly="readonly" onclick="this.focus(); this.select()" rows="5" style="width: 100%;"><?php echo aawp_get_log( __( 'No entries yet. ', 'aawp' ) ); ?></textarea>
            </p>
        ...
        public function render_support_page() {
            ...
            <div id="poststuff">
                ...
                <?php do_action( 'aawp_support_notices', $aawp_plugin_slug ); ?>
                    ...
                    <div id="post-body" class="metabox-holder columns-2 aawp-clearfix">
                        ...
                        <div id="postbox-container-1" class="postbox-container">
                            <div class="meta-box-sortables">
                                <?php do_action( 'aawp_support_infoboxes', $aawp_plugin_slug ); ?>
                            </div>
                        </div>

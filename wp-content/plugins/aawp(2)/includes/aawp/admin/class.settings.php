...
if (!class_exists('AAWP_Settings')) {
    ...
    class AAWP_Settings {
        ...
        public function __construct()
        {
            ...
            add_action( 'aawp_admin_menu', array( &$this, 'add_admin_menu'), 90 );
        ...
        public function render_settings_page() {
            ...
            //require_once $aawp_plugin_path . 'includes/aawp/admin/infoboxes.php';
            //require_once $aawp_plugin_path . 'includes/aawp/settings/notices.php';
            //require_once self::$plugin_path . 'includes/aawp/settings/page.php';
            ...
            <div class="wrap aawp-wrap">
                ...
                <?php do_action( 'aawp_settings_notices', $aawp_plugin_slug ); ?>
                    ...
                    <div id="post-body" class="metabox-holder columns-2 aawp-clearfix">
                        ...
                        <div id="postbox-container-1" class="postbox-container">
                            <div class="meta-box-sortables">
                                <?php do_action( 'aawp_settings_infoboxes', $aawp_plugin_slug ); ?>
                            </div>
                        </div>

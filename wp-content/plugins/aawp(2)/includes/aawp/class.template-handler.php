    ...
    class AAWP_Template_Handler extends AAWP_Template_Functions {
        ...
        private function render_template_advanced() {
            ...
            if ( ! empty ( $template ) ) {
                ...
                if ( file_exists( trailingslashit( $aawp_plugin_path . '/templates/products/' ) . $template . '.php' ) ) {
            ...
            if ( ! empty( $template ) && ! $product_template_validation ) {
                ...
                // Check if template is layout
                if ( file_exists( trailingslashit( $aawp_plugin_path . '/templates/' ) . $template . '.php' ) ) {
        ...
        private function display_notice_products_not_found() {
            ...
            $not_found_text = ( ! empty( $this->options['functions'][$this->type . '_no_products_found_text'] ) ) ? esc_html( $this->options['functions'][$this->type . '_no_products_found_text'] ) : null;

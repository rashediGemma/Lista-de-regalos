...
if ( !class_exists( 'AAWP_Widget_Bestseller' ) ) {

    /**
     * Adds AAWP_Widget widget.
     */
    class AAWP_Widget_Bestseller extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                'aawp_widget_bestseller', // Base ID
                'AAWP - ' . __( 'Amazon Bestseller List', 'aawp' ), // Name
                array( 'description' => __( 'Display an automated bestseller list.', 'aawp' ), ) // Args
            );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            if ( ! empty( $keys ) && ! empty( $template ) ) {
                ...
                // Execute
                aawp_widget_do_shortcode( 'bestseller', $keys, $widget_template, $atts );
        ...
        public function form( $instance ) {
            ...
            $styles = aawp_get_widget_styles( $type = 'bestseller' );
            $templates = aawp_get_widget_templates( $type = 'bestseller' );
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'keys' ); ?>"><?php _e( 'Keyword or Browse Node ID:', 'aawp' ); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'keys' ); ?>" name="<?php echo $this->get_field_name( 'keys' ); ?>" type="text" value="<?php echo esc_attr( $keys ); ?>" placeholder="<?php _e( 'e.g. mainboard or 430172031', 'aawp' ); ?>">
                <br />
                <small><?php _e( 'Enter a keyword or browse node id.', 'aawp' ); ?></small>
            </p>
            <p>
            ...
            <ul class="aawp-widget-docs-list">
                <li><a href="<?php echo esc_url( aawp_get_page_url('docs:bestseller') ); ?>" target="_blank" rel="nofollow"><?php _e('Documentation', 'aawp'); ?></a></li>

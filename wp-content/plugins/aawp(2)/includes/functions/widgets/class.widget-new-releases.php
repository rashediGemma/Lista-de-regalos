...
if ( !class_exists( 'AAWP_Widget_New_Releases' ) ) {
    ...
    class AAWP_Widget_New_Releases extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'keys' ); ?>"><?php _e( 'Browse Node ID:', 'aawp' ); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'keys' ); ?>" name="<?php echo $this->get_field_name( 'keys' ); ?>" type="text" value="<?php echo esc_attr( $keys ); ?>" placeholder="<?php _e( 'e.g. 430172031', 'aawp' ); ?>">
                <br />
                <small><?php _e( 'Enter a browse node id.', 'aawp' ); ?></small>
            </p>
            <p>

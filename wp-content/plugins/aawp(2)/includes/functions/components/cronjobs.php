 ...
 */
function aawp_support_cronjobs( $plugin_url ) {
    ...
    <tr>
        ...
        <td>
            <p>
                ...
                <code style="font-size: 12px;"><?php echo $plugin_url; ?>public/jobs/update_cache.php?key=<?php echo $cronjob_key; ?></code>
            </p>
            <p>
                <?php _e('Renewing product ratings', 'aawp'); ?><br />
                <code style="font-size: 12px;"><?php echo $plugin_url; ?>public/jobs/update_rating_cache.php?key=<?php echo $cronjob_key; ?></code>
            </p>
        </td>
    </tr>
    <?php

...
if ( !class_exists( 'AAWP_Extended_Functions' ) ) {
    ...
    new AAWP_Extended_Functions( $this );
}
...
function aawp_get_amazon_prime_url( $country = null, $tracking_id = null ) {
    ...
    if ( empty( $country ) ) {
        ...
        $country = ( isset( $api_options['country'] ) ) ? $api_options['country'] : null;
    }
...
function aawp_get_prime_check_logo( $country, $tracking_id = false, $atts = array() ) {
    ...
    $country = apply_filters( 'aawp_amazon_prime_country', $country, $atts );
    ...
    */
    ...
    $tracking_id = apply_filters( 'aawp_amazon_prime_tracking_id', $tracking_id, $atts );
